      ...
      <div className=" lg:flex-row md:flex-col sm:flex-col flex lg:justify-between relative  ">
         ...
         <div className="flex flex-col lg:gap-10 md:gap-10 sm:gap-4 sm:px-[5px] sm:py-[50px] lg:my-[110px] z-10">
            <div className="flex lg:gap-10 sm:gap-4 md:gap-10">
              <img className="lg:w-[300px] md:w-[220px] sm:w-[140px] h-auto object-contain " src={foodImage1} alt="this is img"></img>
              <img className="lg:w-[300px] md:w-[220px] sm:w-[140px] h-auto object-contain " src={foodImage2} alt="this is img"></img>
            </div>
            <div className="flex lg:gap-10 sm:gap-4 md:gap-10">
              <img className="lg:w-[300px] md:w-[220px] sm:w-[140px] h-auto object-contain " src={foodImage3} alt="this is img"></img>
              <img className="lg:w-[300px] md:w-[220px] sm:w-[140px] h-auto object-contain " src={foodImage4} alt="this is img"></img>
            </div>
         </div>
         <img className="fixed w-[1000px] h-auto mx-auto opacity-20 object-cover " src={foodbg} alt="background"></img>
      </div>
    </div>
  )
}
