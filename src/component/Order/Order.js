...
import foodImage1 from "../../Image/food11.png";
        ...
        <div className="py-28 px-4 md:px-6 2xl:px-20 2xl:mx-auto bg-black text-white">
          ...
          <div className="mt-10 flex flex-col xl:flex-row justify-center items-stretch  w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
            <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
              <div className="bg-dark rounded-lg border border-gray flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
