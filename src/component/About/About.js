        ...
        <div className="flex lg:flex-row sm:flex-col justify-between">
          <div className="z-10 sm:px-[20px] lg:px-[70px] py-10">
            <h1 className="lg:text-4xl sm:text-3xl text-green font-bold mb-4">
              We make healthy eating taste delicious! We deliver healthy upscale
              meals
            </h1>
            <p className="text-white text-xl">
              Are you hungry? Did you have a long and stressful day? Interested
              in getting a cheesy pizza delivered to<br></br> your office or
              looking to avoid the weekly shop? Then foodpanda Bangladesh is the
              right destination for you!<br></br> foodpanda offers you a long
              and detailed list of the best restaurants and shops near you to
              help make<br></br> your everyday easier. Our online food <br></br>
              delivery service has it all, whether you fancy a juicy burger from
              Takeout, fresh sushi from Samdado <br></br>or peri peri chicken
              from Nando's,<br></br> CyFood Bangladesh has over 2000 restaurants
              available from Dhaka to Chittagong through to Sylhet. Did you<br></br> 
              know you can order your groceries<br></br> and more from
              foodpanda, too? Check out CyFood shops for favourite partners like
              Unimart, Suborno, Shwapno,<br></br> Bengal Meat, and much more.
              Sit back and relax
            </p>
            <div className="">
              <Link to="/contact">
