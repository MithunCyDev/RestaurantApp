          ...
          <div>
            <div className="2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-6">
              <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center bg-dark px-8 py-6 rounded-lg">
                  ...
                  <span className="text-lg font-semibold text-green">Any Request Or Need Please Contact Us?</span>
                  <Link to="/contact">
                    <motion.button
                      whileTap={{ scale: 0.9 }}
              ...
              <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                ...
                <div className="w-full lg:w-8/12 lg:pt-8 bg-dark rounded-lg border border-gray">
                  <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                    <div className="p-4 pb-6 flex justify-center flex-col items-center">
                      ...
                      <img
                        ...
                        alt="Alexa featured Img"
                      />
                      <p className="font-medium text-md leading-5 text-white mt-4">
                        Alexa <span className="text-gray">(Co-Founder)</span>
                      </p>
                    </div>
                    <div className="p-4 pb-6 flex justify-center flex-col items-center">
                      <img
                      ...
                      />
                      <p className="font-medium text-md leading-5 text-white mt-4">
                        Olivia<span className="text-gray">(CEO)</span>
                      </p>
                    </div>
                    <div className="p-4 pb-6 flex justify-center flex-col items-center">
                      <img
                      ...
                      />
                      <p className="font-medium text-md leading-5 text-white mt-4">
                        Liam<span className="text-gray">(Editor)</span>
                      </p>
                    </div>
                    <div className="p-4 pb-6 flex justify-center flex-col items-center">
                      <img
                      ...
                      />
                      <p className="font-medium text-md leading-5 text-white mt-4">
                        Elijah<span className="text-gray">(Co-Founder)</span>
                      </p>
                    </div>
                  </div>
                </div>
