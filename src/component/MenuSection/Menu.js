      ...
      <div className="bg-dark lg:py-20 lg:pt-20 sm:py-10 -mb-6 sm:px-[20px] lg:px-[70px]">
        <div className="flex justify-center">
          <div className="lg:mb-10 sm:-mb-8">
            <h1 className="text-white font-medium lg:text-[50px] sm:text-[23px]">
              Our Menu
        ...
        <div
          className="flex items-center lg:justify-center lg:py-10 lg:gap-10 sm:gap-4 cursor-pointer scroll-smooth overflow-x-scroll scrollbar-hide
        ...
        >
          {itemsArray.map((items) => (
            <div
              ...
              className={`${
                filter === items.name ? "bg-green" : "bg-black"
              } bg-opacity-80 lg:min-w-[200px] lg:min-h-[70px]
              sm:min-w-[160px] sm:min-h-[60px] rounded-md text-white
              flex justify-center items-center transition-all duration-100`}
            >
              <h1 className="lg:text-md sm:text-sm font-semibold">
               
                {items.name}
              </h1>
              <div
                className={`${
                  filter === items.name ? "bg-white text-green" : "bg-green"
                } ml-3 py-2 px-2 rounded-full`}
              >
