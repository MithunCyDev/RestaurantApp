      ...
      <div className="flex justify-between w-full lg:py-20 sm:py-8 sm:pt-14 sm:px-[20px] lg:px-[70px]">
        ...
        <div className="flex gap-4 sm:mt-20 lg:mt-0">
          <MdOutlineArrowForwardIos
            className="text-white lg:block md:hidden sm:hidden bg-green w-10 h-8 py-2 px-2 rounded-md
          hover:bg-notblack transition-all duration-100 cursor-pointer"
            onClick={() => handleClick("left")}
            style={{ backgroundColor: !move && "black" }}
          />
          <MdOutlineArrowForwardIos
            className="rotate-180 text-white lg:block md:hidden sm:hidden bg-green w-10 h-8 py-2 px-2 rounded-md
          hover:bg-notblack transition-all duration-100 cursor-pointer"
